...
//        user2.addBal(3);
        ...
        Book book = new Book("Mina ja nemad", 1, 200, "Peeter Pan", "Raamatukogu1", 3);
        Book book2 = new Book("Nemad teavad", 2, 250, "Matilda Mads", "Raamatukogu1", 2);
        ...
        Reader reader1 = new Reader("Mat", "Melis", 30, 2, true, 0);
